...
static const _DriveCommand_type_support_symbol_names_t _DriveCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avaj_car_control, msg, DriveCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, avaj_car_control, msg, DriveCommand)),
  }
};
...
{
  return &::avaj_car_control::msg::rosidl_typesupport_cpp::DriveCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, avaj_car_control, msg, DriveCommand)() {
  return get_message_type_support_handle<avaj_car_control::msg::DriveCommand>();
}
