...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/control_center"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/control_center/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/control_center/environment/path.sh"
