...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/avaj_slam"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/avaj_slam/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/avaj_slam/environment/path.sh"
